...
export const ACHADOS: Achado[] = [
  ...
  },
  {
    ...
    numero: "03",
    data: "2026-09-25",
    titulo: "Desde 2014, mulheres aparecem mais entre as vices do que entre as titulares",
  ...
  },
  {
    ...
    texto: "Os registros de candidaturas para deputada e deputado caíram 30% em relação a 2022, em todos os estados. As candidaturas de mulheres caíram 27%, e as de homens, 32%. A participação feminina subiu porque as candidaturas de homens caíram mais.",
    barras: [
  ...
  },
  {
    ...
    texto: "Na fotografia de 25/09, há 17 mulheres pretas candidatas a presidente, governadora ou senadora. O snapshot atual não traz, de forma auditável, os campos necessários para atribuir diferenças entre essas candidaturas a partido, federação ou coligação.",
    barras: [],
