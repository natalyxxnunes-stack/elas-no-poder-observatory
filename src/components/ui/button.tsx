...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap border text-sm font-semibold cursor-pointer transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "border-ink bg-primary text-primary-foreground hover:bg-plum-soft",
        destructive: "border-ink bg-destructive text-destructive-foreground hover:bg-destructive/90",
        outline:
          "border-ink bg-background hover:bg-accent hover:text-accent-foreground",
        secondary: "border-ink bg-secondary text-secondary-foreground hover:bg-solar",
